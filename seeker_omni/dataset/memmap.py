...
class MemmapDataset:
    ...
    def __init__(self, data_dir: str | Path):
        ...
        # 训练代码会使用ds.meta.seq_len / ds.meta.vocab_size等字段
    ...
    def __getitem__(self, idx: int):
        ...
        if self._image_feat is not None:
            out["image_feats"] = torch.from_numpy(self._image_feat[int(idx)])
        return out
