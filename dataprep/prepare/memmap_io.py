...
class MemmapWriter:
    """将token/labels/attention 写入到memmap 目录"""
    ...
    def __init__(
        ...
        *,
        ...
        self._labels_dtype = np.dtype(self.meta.label_dtype)
    ...
    def write(
        ...
        *,
        ...
        self.labels[idx] = labels.astype(self.labels_dtype, copy=False)
